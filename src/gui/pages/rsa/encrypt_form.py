...
class RSAEncryptForm(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        self.initialize()

        hg.insert_header(self, 'RSA Encryption')
    ...
    def render_text_message_frame(self):
        ...
        hg.create_label(t_message_frame,
                        'or write your plaintext down here:', 0, 0)
    ...
    def render_text_key_frame(self):
        ...
        hg.create_label(
            t_key_frame, 'or write your key down here: (format: e n)', 0, 0)
    ...
    def render_output_frame(self):
        ...
        hg.create_label(
            output_frame, 'Output file\'s name (if using file it\'s requirement):', 0, 0)
    ...
    def execute(self):
        ...
        try:
            ...
            print("Error occured when encrypt using RSA!")
            print(e)
