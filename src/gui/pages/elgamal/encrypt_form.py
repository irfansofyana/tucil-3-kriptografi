...
class ElgamalEncryptForm(tk.Frame):
    def __init__(self, parent, controller):
        ...
        hg.insert_header(self, 'Elgamal Encryption')
    ...
    def render_message_frame(self):
        ...
        hg.create_label(message_frame, 'Message File', 0, 0)
    ...
    def render_text_message_frame(self):
        ...
        hg.create_label(t_message_frame, 'or write your message down here:', 0, 0)
